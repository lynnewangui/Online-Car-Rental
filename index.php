      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Welcome to Driveway car rentals system Find the ideal car for you.</h1>
            <p>We have more cars for you to hire, drive at you comfort. </p>
        </div>
      </div>
    </div>
  </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Find the Best <span>Car For You at Driveway</span></h2>
